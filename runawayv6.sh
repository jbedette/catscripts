...
NC='\e[0m' #no color
host_list=`netgrouplist linux-login-sys ece-secure-sys cs-secure-sys`
#host_list="rita"
...
cpu_mem_check ()
{
    #echo -e "Hostname is: $i \n Uptime is:"
    #ssh -o ConnectTimeout=5 $USER@$i 'uptime;'
    #echo -e "\n Number of cores is:"
    #ssh -o ConnectTimeout=5 $USER@$i nproc
    echo $i
